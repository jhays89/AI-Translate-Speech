...
namespace speech_translation
{
    class Program
    {
        ...
        {
            // Lesson: https://microsoftlearning.github.io/AI-102-AIEngineer/Instructions/08-translate-speech.html
            // Additional: lesson also shows how to use an audio input from a file instead of a mic
